...
public class AnnotationDependencyFieldInjectionDemo {
    ...
    /**
     * 方式1：@Autowired (byType方式)
     */
    @Autowired
    private UserHolder userHolder;
    // private  static UserHolder userHolder; // @Autowired 会忽略掉静态字段，为 null

    /**
     * 方式2：@Resource (byType方式)
     */
    @Resource
    ...
    public static void main(String[] args) {
        ...
        // 注册 Configuration Class（配置类） -> 配置类 也是 Spring Bean
